...
def call_local_api(payload: dict = None, method: str = "POST", url: str = "https://api-gateway-cgv4.onrender.com/api", timeout: int = 5) -> dict:
    ...
    if (intent == "ask_route" or intent == "ask_destination"):
        ...
        try:
            ...
            response = call_local_api(
                payload=params,
                method="GET", 
                url="https://api-gateway-cgv4.onrender.com/api/trips/search",
                timeout=10
            )
